...
public interface MovieDetailService {
     ...
     * the movies objects.
     *
     * @param movie A {@link Movie} object containing a valid movie id or a valid
     ...
     *
     * @param movieId A valid movie id.
     ...
     *
     * @param movieId    A valid movie id.
     * @param result     A List of {@link Review} objects. The reviews obtained
     *                   invoking this method are appended to this list.
     * @param reviewType 3 different review types are possible: "all", "top_critic" and
