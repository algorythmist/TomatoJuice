...
public interface DvdService {
     ...
     * 
     */
    List<Movie> getTopRentalsMovies(Locale country, int limit)
	    throws IOException;
     ...
     * 
     */
    List<Movie> getCurrentReleaseDvds(Locale country, int limit, int page)
	    throws IOException;
     ...
     * 
     */
    List<Movie> getNewReleaseDvds(Locale country, int limit, int page)
	    throws IOException;
     ...
     * 
     */
    List<Movie> getUpcomingDvds(Locale country, int limit, int page)
	    throws IOException;
